...
public class FindWords {
  ...
  /**
   * For current word iteration, this method retrieve the possible options for the next letter. Once
   * identified the possible next coordinates, it performs a deletion of the already used
   * coordinates based on the key: coordString
   * 
   * @param currentWord
   * @return
   */
